...
MODEL=/hdfs/resrchvc/t-jianya/RetrieveNMT/data/MD/retrieve-de2en-top2/concat/model/de2en-ngram0
mkdir -p $MODEL
python3 train.py $TEXT \
    ...
    --use-segment-emb --use-predictlayer --predict-loss --n-gram 0 | tee -a $MODEL/log.txt | tee -a $MODEL/log.txt