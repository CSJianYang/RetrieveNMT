...
if [ "$src" == "en" -a "$tgt" == "de" ]; then
    MODEL=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-de/en2de/top2/model/en2de-only-predict/checkpoint_best.pt
    TEXT=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-de/en2de/top2/data-bin/
    lenpen=1.3
elif [ "$src" == "de" -a "$tgt" == "en" ]; then
    MODEL=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-de/de2en/top2/model/de2en-only-predict/checkpoint_best.pt
    TEXT=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-de/de2en/top2/data-bin/
    lenpen=1.0
elif [ "$src" == "en" -a "$tgt" == "fr" ]; then
    MODEL=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-fr/en2fr/top2/model/en2fr-only-predict/checkpoint_best.pt
    TEXT=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-fr/en2fr/top2/data-bin/
    lenpen=1.0
elif [ "$src" == "fr" -a "$tgt" == "en" ]; then
    MODEL=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-fr/fr2en/top2/model/fr2en-only-predict/checkpoint_best.pt
    TEXT=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-fr/fr2en/top2/data-bin/
    lenpen=1.0
elif [ "$src" == "en" -a "$tgt" == "es" ]; then
    MODEL=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-es/en2es/top2/model/en2es-only-predict/checkpoint_best.pt
    TEXT=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-es/en2es/top2/data-bin/
    lenpen=1.5
elif [ "$src" == "es" -a "$tgt" == "en" ]; then
    MODEL=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-es/es2en/top2/model/es2en-only-predict/checkpoint_best.pt
