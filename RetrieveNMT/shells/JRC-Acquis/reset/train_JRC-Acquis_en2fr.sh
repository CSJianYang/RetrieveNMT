...
MODEL=/hdfs/msrmt/t-jianya/RetriveNMT/data/JRC-Acquis/RetriveNMT/en-fr/en2fr/top2/model/en2fr
python3 train.py $TEXT \
    ...
    --lr 0.1 --min-lr 1e-16 \
    --update-freq 2 --ddp-backend=no_c10d --share-all-embeddings --max-source-positions 2048 