...
def parse_args():
    ...
    parser.add_argument('--tgt-set', '-tgt-set', type=str,
                        default=r'/home/v-jiaya/RetrieveNMT/data/MD/en-de/iwslt14-en-de/train/train.de',
                        help='target file')
    parser.add_argument('--retrieve-set', '-retrieve-set', type=str, default=r'/home/v-jiaya/RetrieveNMT/data/MD/en-de/iwslt14-en-de/train/train.en.retrive.20',help='target directory')
    parser.add_argument('--dest-set', '-dest-set', type=str,
                        default=r'/home/v-jiaya/RetrieveNMT/data/MD/retrieve-en2de/train/train.en',
                        help='dest file')
    parser.add_argument('--new-tgt-set', '-new-tgt-set', type=str,
                        default=r'/home/v-jiaya/RetrieveNMT/data/MD/retrieve-en2de/train/train.de',
                        help='new target file')
    parser.add_argument('--topK', '-topK', type=int, default=2, help='Select TopK Candidates')
