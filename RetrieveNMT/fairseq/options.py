...
def add_preprocess_args(parser):
    ...
    # fmt: off
    group.add_argument("-s", "--source-lang", default="jp", metavar="SRC",
                       help="source language")
    group.add_argument("-t", "--target-lang", default="zh", metavar="TARGET",
                       help="target language")
    group.add_argument("--trainpref", metavar="FP", default="",
                       help="train file prefix")
    group.add_argument("--validpref", metavar="FP", default="",
                       help="comma separated, valid file prefixes")
    group.add_argument("--testpref", metavar="FP", default="",
                       help="comma separated, test file prefixes")
    group.add_argument("--destdir", metavar="DIR", default="",
                       help="destination dir")
    group.add_argument("--thresholdtgt", metavar="N", default=10, type=int,
                       help="map words appearing less than threshold times to unknown")
    group.add_argument("--thresholdsrc", metavar="N", default=10, type=int,
                       help="map words appearing less than threshold times to unknown")
    ...
    group.add_argument("--mask", action="store_true", help="if src and tgt mask")
    group.add_argument("--src-mask", action="store_true", help="if src mask")
    group.add_argument("--tgt-mask", action="store_true", help="if tgt mask")
    ...
    group.add_argument("--workers", metavar="N", default=20, type=int,
...
def add_dataset_args(parser, train=False, gen=False):
    ...
    if train:
        group.add_argument("--reset-target-embedding", action="store_true", help="remove target embedding state while loading checkpoint")
        group.add_argument("--mask-subset", metavar="FP", default=None, help="mask file prefix")
        group.add_argument("--src-mask", action="store_true", help="if src mask")
        group.add_argument("--tgt-mask", action="store_true", help="if tgt mask")
...
def add_optimization_args(parser):
    ...
    group.add_argument('--max-update', '--mu', default=100, type=int, metavar='N',
    ...
    group.add_argument('--optimizer', default='sgd', metavar='OPT',
                       choices=OPTIMIZER_REGISTRY.keys(),
                       help='Optimizer')
    group.add_argument('--lr', '--learning-rate', default='0.01', type=eval_str_list,
...
def add_generation_args(parser):
    ...
    group.add_argument('--easy-first', action='store_true', help="")
    group.add_argument('--easy-direction', action='store_true', help="")
    ...
    group.add_argument('--avgpen', default=1, type=float,
                       help='average attention score <1.0 selct more words >1.0 select fewer words')
    ...
    group.add_argument('--output', default="", type=str, metavar='N',
                       help='output file')
    # fmt: on
    return group
...
def add_interactive_args(parser):
    ...
    group.add_argument('--output-file', default='-', type=str, metavar='FILE',
                       help='')
    group.add_argument('--input_files', default=[], nargs=2,
                       help='file to read from; use - for stdin')
    # fmt: on
