...
TEXT=/hdfs/msrmt/v-jiaya/RetriveNMT/data/JRC-Acquis/RetriveNMT/en-fr/en2fr/top2/data-bin/
MODEL=/hdfs/msrmt/v-jiaya/RetriveNMT/data/JRC-Acquis/RetriveNMT/en-fr/en2fr/top2/model/en2fr-simple-update1
