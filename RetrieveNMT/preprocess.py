...
def main(args):
    ...
    def make_all(lang, vocab):
        if args.trainpref:
            ...
            if args.mask:
                make_dataset(vocab, "{}.mask".format(args.trainpref), "mask", lang, num_workers=args.workers)
            elif args.src_mask and args.source_lang == lang:
                make_dataset(vocab, "{}.mask".format(args.trainpref), "mask", lang, num_workers=args.workers)
            elif args.tgt_mask and args.target_lang == lang:
                make_dataset(vocab, "{}.mask".format(args.trainpref), "mask", lang, num_workers=args.workers)
        if args.validpref:
