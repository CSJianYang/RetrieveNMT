...
TEXT=/hdfs/msrmt/v-jiaya/RetriveNMT/data/JRC-Acquis/baseline/train/en-de/data-bin/
MODEL=/hdfs/msrmt/v-jiaya/RetriveNMT/data/JRC-Acquis/baseline/train/en-de/model/de2en-base
