...
def build_progress_bar(args, iterator, epoch=None, prefix=None, default='tqdm', no_progress_bar='none'):
    ...
    if args.log_format == 'json':
        ...
        bar = simple_progress_bar(iterator, epoch, prefix, args.log_interval, args=args)
...
class simple_progress_bar(progress_bar):
    ...
    def __init__(self, iterable, epoch=None, prefix=None, log_interval=1000, args=None):
        super().__init__(iterable, epoch, prefix)
        self.log_interval = log_interval
        self.stats = None
        self.distributed_rank = args.distributed_rank
        if self.distributed_rank == 0:
            self.log_file = args.log_file
            self.wfile = open(self.log_file, "a+", encoding="utf-8")
