...
MODEL=/home/v-jiaya/RetriveNMT/data/JRC-Acquis/baseline/train/en-de/model/en2de-base
python3 /hdfs/resrchvc/v-jiaya/RetriveNMT/fairseq-baseline/train.py $TEXT \
