...
MODEL=/hdfs/resrchvc/t-jianya/RetrieveNMT/data/MD/retrieve-en2de-top2/concat/model/en2de-CopyNet-fp16
mkdir -p $MODEL
python3 train.py $TEXT \
    ...
    --lr 0.1 --min-lr 1e-16 \
    --update-freq 2 --ddp-backend=no_c10d --share-all-embeddings --max-source-positions 10000 --fp16 | tee -a $MODEL/log.txt