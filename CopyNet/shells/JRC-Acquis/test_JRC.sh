...
if [ "$src" == "en" -a "$tgt" == "de" ]; then
    MODEL=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-de/en2de/top2/model/CopyNet-en2de/checkpoint_best.pt
    TEXT=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-de/en2de/top2/data-bin/
    lenpen=1.0
elif [ "$src" == "de" -a "$tgt" == "en" ]; then
    MODEL=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-de/de2en/top2/model/CopyNet-de2en/checkpoint_best.pt
    TEXT=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-de/de2en/top2/data-bin/
    lenpen=1.0
elif [ "$src" == "en" -a "$tgt" == "fr" ]; then
    MODEL=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-fr/en2fr/top2/model/CopyNet-en2fr/checkpoint_70_335000.pt
    TEXT=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-fr/en2fr/top2/data-bin/
    lenpen=1.0
elif [ "$src" == "fr" -a "$tgt" == "en" ]; then
    MODEL=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-fr/fr2en/top2/model/CopyNet-fr2en/checkpoint_best.pt
    TEXT=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-fr/fr2en/top2/data-bin/
    lenpen=1.0
elif [ "$src" == "en" -a "$tgt" == "es" ]; then
    MODEL=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-es/en2es/top2/model/CopyNet-en2es/checkpoint_best.pt
    TEXT=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-es/en2es/top2/data-bin/
    lenpen=1.0
elif [ "$src" == "es" -a "$tgt" == "en" ]; then
    MODEL=/home/v-jiaya/RetrieveNMT/data/JRC-Acquis/RetriveNMT/en-es/es2en/top2/model/CopyNet-es2en/checkpoint_best.pt
