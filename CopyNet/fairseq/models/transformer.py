...
class TransformerEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, src_lengths):
        ...
        for layer in self.layers:
            ...
            retrieve_target_x = layer(retrieve_target_x, retrieve_target_padding_mask)
        ...
        return {
            ...
            'TM': retrieve_target_x,  # T x B x C
            'TM_padding': retrieve_target_padding_mask, # B x T
            'TM_tokens': retrieve_target_tokens
        }
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False, left_pad=False, final_norm=True):
        ...
        self.layers = nn.ModuleList([])
        self.layers.extend([
            TransformerDecoderLayer(args, no_encoder_attn) if i != args.decoder_layers-1 else TransformerDecoderLayer(args, no_encoder_attn, copyNet=True)
