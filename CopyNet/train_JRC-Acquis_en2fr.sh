...
TEXT=/hdfs/msrmt/v-jiaya/RetriveNMT/data/JRC-Acquis/baseline/train/en-fr/data-bin/
MODEL=/hdfs/msrmt/v-jiaya/RetriveNMT/data/JRC-Acquis/baseline/train/en-fr/model/en2fr-base
