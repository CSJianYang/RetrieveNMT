...
TEXT=/hdfs/msrmt/v-jiaya/RetriveNMT/data/JRC-Acquis/RetriveNMT/en-de/de2en/top2/data-bin/
MODEL=/hdfs/msrmt/v-jiaya/RetriveNMT/data/JRC-Acquis/RetriveNMT/en-de/de2en/top2/model/de2en-simple-update1
python3 /hdfs/msrmt/v-jiaya/RetriveNMT/fairseq-baseline/train.py $TEXT \
    ...
    --lr 0.1 --min-lr 1e-16 \
    --update-freq 1 --ddp-backend=no_c10d --skip-invalid-size-inputs-valid-test