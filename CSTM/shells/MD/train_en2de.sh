...
TEXT=/mnt/default/RetrieveNMT/data/MD/retrieve-en2de/concat/data-bin/
MODEL=/hdfs/resrchvc/t-jianya/RetrieveNMT/data/MD/retrieve-en2de/concat/model/en2de-CSTM1
python3 train.py $TEXT \
    ...
    --lr 0.1 --min-lr 1e-16 \
    --update-freq 1 --ddp-backend=no_c10d --fp16 --share-all-embeddings --max-source-positions 20480