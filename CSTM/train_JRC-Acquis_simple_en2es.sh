...
TEXT=/hdfs/msrmt/v-jiaya/RetriveNMT/data/JRC-Acquis/RetriveNMT/en-es/en2es/top2/data-bin/
MODEL=/hdfs/msrmt/v-jiaya/RetriveNMT/data/JRC-Acquis/RetriveNMT/en-es/en2es/top2/model/en2es-simple-update1
