...
class BaseFairseqModel(nn.Module):
    ...
    def get_tgt_masks(self, sample):
        """Get targets from either the sample or the net's output."""
        return sample['tgt_mask']

    def get_src_masks(self, sample):
        """Get targets from either the sample or the net's output."""
        return sample['src_mask']
    ...
    def get_masked_probs(self, net_output, log_probs, sample=None):
        """Get normalized probabilities (or log probs) from a net's output."""
